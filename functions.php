...
if (!function_exists('child_theme_configurator_css')) :
	...
	echo '<script>let ajax_url = "' . admin_url("admin-ajax.php") . '";</script>';
		...
		// new homepage assets
		wp_enqueue_style('kd-new-homepage-css', get_stylesheet_directory_uri() . '/assets/css/optimized-homepge.css' , array() , '004' , 'all');
		...
		wp_enqueue_script('kd-new-home-loaders', get_stylesheet_directory_uri() . '/assets/js/homepage-loader.js', array(), '20', true);
	}
endif;
